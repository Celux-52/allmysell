/**
 * ⚠️ TODO: Bu dosyada 30+ makale olduğunda CMS'e (Sanity/Contentful) veya MDX'e geçiş yap!
 * Şu anki makale sayısı: 13
 * Hardcoded HTML 30+ makalede yönetilemez hale gelir.
 * Bu notu her yeni makale eklediğinde güncelle.
 */
...
export const articles: Article[] = [
  {
    ...
    en: {
      ...
      content: '<p>Let me paint you a picture. You hire a design agency. They deliver a gorgeous website with smooth animations, custom illustrations, the whole nine yards. You launch it. Google Analytics shows decent traffic. But weeks pass and your inbox stays empty. No form submissions, no demo requests, no phone calls.</p><p>We see this exact scenario play out with at least three out of five companies that come to us for help. The website looks expensive, but it\'s essentially a digital brochure that nobody reads past the first scroll.</p><p>Here\'s what\'s actually going wrong.</p><h2>1. Your Hero Section Says Nothing</h2><p>"Innovative solutions for a digital world." We\'ve all seen headlines like this. They sound professional, sure. But they tell the visitor absolutely nothing about what you actually do or why they should care.</p><p>A real person lands on your site with a specific problem. They\'re not looking for "innovation" — they\'re looking for someone who can fix their broken checkout flow, or build them a dashboard that doesn\'t crash every Tuesday.</p><p>Your hero section has roughly 3 seconds to answer one question: <strong>"Is this company going to solve MY problem?"</strong> If the answer isn\'t immediately obvious, they bounce. It\'s that simple.</p><h2>2. The Contact Form Is Buried</h2><p>We audited a SaaS company\'s website last quarter. Beautiful design, solid content, clear value proposition. Their contact form? Hidden behind three clicks: Menu → Company → Contact. That\'s an eternity on the web.</p><p>Every single page should have a visible path to conversion. Not necessarily a giant form — even a sticky "Book a Call" button in the header works. The point is: when someone decides they want to talk to you, that option needs to be <em>right there</em>, not three pages away.</p><h2>3. You\'re Talking About Yourself, Not Their Problem</h2><p>Most B2B websites read like a resume. "We were founded in 2015. We have 47 employees. We use cutting-edge technology." Cool. Your visitor doesn\'t care.</p><p>What they care about is whether you understand their pain. Instead of "We build custom software," try "Your operations team is drowning in spreadsheets. We build systems that eliminate manual data entry entirely."</p><p>See the difference? One talks about you. The other talks about them. Guess which one converts.</p><h2>4. Page Speed Is an Afterthought</h2><p>Google\'s own research shows that 53% of mobile users abandon a site that takes longer than 3 seconds to load. Three seconds. Most corporate websites we audit clock in at 6-8 seconds on mobile.</p><p>The culprit is almost always the same: unoptimized images, render-blocking JavaScript, and a WordPress theme loaded with 40 plugins. It doesn\'t matter how good your content is if people never see it because they left before the page finished loading.</p><p>This is exactly why we build with Next.js and server-side rendering — the HTML arrives fully formed, no waiting for JavaScript to paint the screen.</p><h2>5. No Social Proof Where It Matters</h2><p>You might have a testimonials page. That\'s nice. But almost nobody navigates to a dedicated testimonials page unprompted.</p><p>Social proof needs to appear <em>in context</em>. Right below your pricing? Show a quote from a customer who got 3x ROI. Next to your contact form? Show how many companies you\'ve worked with. On your services page? Drop in a mini case study with real numbers.</p><p>Trust isn\'t built on a separate page. It\'s built in the moments right before someone makes a decision.</p><h2>The Common Thread</h2><p>All five of these mistakes share a root cause: the website was designed for the company, not for the visitor. Every design decision, every word of copy, every layout choice should start with one question — what does the person on the other side of this screen need right now?</p><p>Get that right, and conversions follow.</p>'
    },
    tr: {
      ...
      content: '<p>Şöyle bir sahne çizeyim. Bir tasarım ajansıyla çalıştınız. Akıcı animasyonlar, özel çizimler, her şey tam istediğiniz gibi oldu. Siteyi yayınladınız. Google Analytics\'e baktığınızda trafik de fena değil. Ama haftalar geçiyor ve gelen kutunuz bomboş. Form dolduran yok, demo talebi yok, arayan yok.</p><p>Bize yardım için gelen her beş şirketin en az üçünde bu senaryoyu birebir görüyoruz. Web sitesi pahalı görünüyor, ama aslında kimsenin ilk kaydırmanın ötesine geçmediği dijital bir broşürden ibaret.</p><p>Peki gerçekte ne oluyor?</p><h2>1. Hero Bölümünüz Hiçbir Şey Söylemiyor</h2><p>"Dijital dünya için yenilikçi çözümler." Hepimiz bu tarz başlıklar gördük. Kulağa profesyonel geliyor, tamam. Ama ziyaretçiye aslında ne yaptığınızı veya neden umursaması gerektiğini söylemiyor.</p><p>Sitenize gelen gerçek bir insan, belirli bir sorunla geliyor. "Yenilik" aramıyor — bozuk ödeme akışını düzeltecek veya her salı çöken dashboard\'u yeniden yapacak birini arıyor.</p><p>Hero bölümünüzün tek bir soruyu yanıtlamak için yaklaşık 3 saniyesi var: <strong>"Bu şirket BENİM sorunumu çözecek mi?"</strong> Cevap hemen belli değilse, çıkıyorlar. Bu kadar basit.</p><h2>2. İletişim Formu Derinlere Gömülmüş</h2><p>Geçen çeyrekte bir SaaS şirketinin web sitesini inceledik. Güzel tasarım, sağlam içerik, net değer önerisi. İletişim formları? Üç tıklamanın arkasında gizli: Menü → Şirket → İletişim. Web\'de bu bir ömür boyu demek.</p><p>Her sayfada dönüşüme giden görünür bir yol olmalı. İllaki kocaman bir form olmasına gerek yok — header\'da yapışkan bir "Görüşme Ayarla" butonu bile yeterli. Mesele şu: biri sizinle konuşmak istediğine karar verdiğinde, bu seçenek tam orada olmalı, üç sayfa ötede değil.</p><h2>3. Kendinizden Bahsediyorsunuz, Onların Sorunlarından Değil</h2><p>Çoğu B2B web sitesi bir özgeçmiş gibi okunuyor. "2015\'te kurulduk. 47 çalışanımız var. Son teknolojiyi kullanıyoruz." Güzel. Ziyaretçinizin umurunda değil.</p><p>Onların umurunda olan şey, siz onların acısını anlıyor musunuz. "Özel yazılım geliştiriyoruz" yerine "Operasyon ekibiniz Excel tablolarında boğuluyor. Biz manuel veri girişini tamamen ortadan kaldıran sistemler kuruyoruz" deneyin.</p><p>Farkı görüyor musunuz? Biri sizden bahsediyor. Diğeri onlardan. Hangisinin dönüşüm sağladığını tahmin edin.</p><h2>4. Sayfa Hızı Sonradan Düşünülmüş</h2><p>Google\'ın kendi araştırması, mobil kullanıcıların %53\'ünün 3 saniyeden uzun yüklenen siteleri terk ettiğini gösteriyor. Üç saniye. İncelediğimiz çoğu kurumsal web sitesi mobilde 6-8 saniyeye oturuyor.</p><p>Suçlu neredeyse her zaman aynı: optimize edilmemiş görseller, render\'ı engelleyen JavaScript ve 40 eklenti yüklü bir WordPress teması. İçeriğiniz ne kadar iyi olursa olsun, insanlar sayfa yüklenmeden çıktıysa bir anlamı yok.</p><p>Tam da bu yüzden Next.js ve sunucu tarafı render ile geliştirme yapıyoruz — HTML tam haliyle geliyor, JavaScript\'in ekranı boyamasını beklemeye gerek kalmıyor.</p><h2>5. Sosyal Kanıt Gerektiği Yerde Yok</h2><p>Belki bir "Referanslar" sayfanız vardır. Güzel. Ama neredeyse kimse kendi kendine ayrı bir referans sayfasına gitmez.</p><p>Sosyal kanıt <em>bağlam içinde</em> görünmeli. Fiyatlandırmanızın hemen altında mı? 3 kat ROI elde eden bir müşterinin yorumunu koyun. İletişim formunuzun yanında mı? Kaç şirketle çalıştığınızı gösterin. Hizmetler sayfanızda mı? Gerçek rakamlarla mini bir vaka çalışması bırakın.</p><p>Güven ayrı bir sayfada inşa edilmez. Birinin karar vermeden hemen önceki anlarda inşa edilir.</p><h2>Ortak Nokta</h2><p>Bu beş hatanın hepsinin ortak bir kök nedeni var: web sitesi ziyaretçi için değil, şirket için tasarlanmış. Her tasarım kararı, her kelime, her düzen seçimi tek bir soruyla başlamalı — ekranın diğer tarafındaki kişinin şu an neye ihtiyacı var?</p><p>Bunu doğru yapın, dönüşümler arkasından gelir.</p>'
    }
  },
  {
