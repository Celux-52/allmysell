    ...
    <div className="min-h-screen bg-[#030712] pt-24 pb-16 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-16">
          <span className="inline-block px-4 py-1.5 text-xs font-semibold tracking-widest uppercase text-orange-400 bg-orange-500/10 rounded-full border border-orange-500/20 mb-6">Contact</span>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="glass-card rounded-2xl p-8">
            ...
            <form className="space-y-5">
              ...
              <div>
                ...
                <input type="text" id="subject" className="w-full px-4 py-3 glass-input rounded-xl text-white placeholder-slate-500" placeholder="How can we help?" />
              </div>
              <div>
                <label htmlFor="message" className="block text-sm font-medium text-slate-300 mb-2">Message</label>
                <textarea id="message" rows={6} className="w-full px-4 py-3 glass-input rounded-xl resize-none text-white placeholder-slate-500" placeholder="Tell us more about your inquiry..." />
              </div>
          ...
          <div className="space-y-6">
              ...
              <div className="mb-6 pb-6 border-b border-white/[0.06]">
                <div className="flex items-center mb-4">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-slate-500 text-sm">Co-Founder &amp; Partner</p>
                  </div>
                </div>
            ...
            <div className="glass-card rounded-2xl p-8">
              <h2 className="text-2xl font-bold mb-6 text-white">Quick Information</h2>
              <div className="space-y-5">
                <div className="flex items-start">
                  ...
                  <div><h3 className="font-semibold text-white mb-1 text-sm">Global E-Commerce Platform</h3><p className="text-slate-500 text-sm">Serving customers worldwide through multiple marketplaces</p></div>
                </div>
                <div className="flex items-start">
                  ...
                  <div><h3 className="font-semibold text-white mb-1 text-sm">Response Time</h3><p className="text-slate-500 text-sm">We typically respond within 24 hours</p></div>
                </div>
              </div>
            </div>
          </div>
