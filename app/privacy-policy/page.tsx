      ...
      <div className="max-w-4xl mx-auto bg-cornsilk rounded-2xl shadow-xl p-8 md:p-12">
        ...
        <div className="prose max-w-none">
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-cornsilk mb-4">1. Introduction</h2>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-cornsilk mb-4">2. Information We Collect</h2>
            <p className="text-gray-300 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-cornsilk mb-4">3. How We Use Your Information</h2>
            <p className="text-gray-300 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-cornsilk mb-4">4. Cookies</h2>
            <p className="text-gray-300 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-cornsilk mb-4">5. Data Security</h2>
            <p className="text-gray-300 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-cornsilk mb-4">6. Third-Party Platforms</h2>
            <p className="text-gray-300 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-cornsilk mb-4">7. Your Rights</h2>
            <p className="text-gray-300 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-cornsilk mb-4">8. Data Retention</h2>
            <p className="text-gray-300 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-cornsilk mb-4">9. Children's Privacy</h2>
            <p className="text-gray-300 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-cornsilk mb-4">10. Changes to This Policy</h2>
            <p className="text-gray-300 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-cornsilk mb-4">11. Contact Us</h2>
            <p className="text-gray-300 leading-relaxed mb-4">
