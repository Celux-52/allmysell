          ...
          {!verified ? (
            <>
              ...
              <div className="text-center animate-slideInUp">
                ...
                <h2 className="text-2xl font-bold text-stone-900 mb-2">Email Verification</h2>
                ...
                <div className="space-y-3">
                  <button
                    ...
                    className="w-full py-3 border-2 border-[#E8750A] text-stone-800 rounded-lg font-semibold hover:bg-olive transition-all"
                  >
                    Resend Email
                  </button>
                  <Link
                    href="/register"
                    className="block py-3 text-stone-500 hover:text-stone-900 text-sm"
                  >
            ...
            <div className="text-center py-8 animate-slideInUp">
              ...
              <h3 className="text-xl font-bold text-stone-900 mb-2">Email Verified!</h3>
