...
export default function HomePage() {
  return (
    <div className="bg-white">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-blue-600 via-purple-600 to-pink-600 text-white py-24 md:py-32">
      ...
      <section className="py-24 bg-gradient-to-b from-white to-gray-50">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-6xl md:text-7xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-purple-600 via-pink-600 to-blue-600 mb-4 tracking-tight">
              Who We Are
            </h2>
            <div className="w-24 h-1.5 bg-gradient-to-r from-purple-600 to-blue-600 mx-auto rounded-full"></div>
          </div>
          <div className="space-y-8">
            <p className="text-xl md:text-2xl text-gray-800 leading-relaxed font-light first-letter:text-7xl first-letter:font-bold first-letter:text-purple-600 first-letter:mr-3 first-letter:float-left">
            ...
            <p className="text-xl md:text-2xl text-gray-800 leading-relaxed font-light">
              Today, AllMySell is not the result of overnight success. It is the result of <span className="font-semibold text-purple-600">sleepless nights, postponed comfort</span>, and the moments when the only decision was to keep going.
            </p>
            
            <div className="bg-gradient-to-r from-purple-600 via-pink-600 to-blue-600 p-[2px] rounded-2xl mt-16">
              <div className="bg-white rounded-2xl p-10 text-center">
                ...
                <p className="text-3xl md:text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-600 via-pink-600 to-blue-600 leading-tight">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {platforms.map((platform, index) => (
              <Link
                key={index}
                href={platform.href}
                className={`group relative bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden transform hover:-translate-y-2 ${!platform.active && 'opacity-75'}`}
              >
                ...
                <div className="p-8">
                  ...
                  <div className={`flex items-center font-semibold ${platform.active ? 'text-purple-600' : 'text-gray-500'}`}>
      ...
      <section className="bg-gradient-to-r from-purple-600 to-blue-600 text-white py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/ebay"
              className="bg-white text-purple-600 px-8 py-4 rounded-full font-semibold hover:bg-blue-50 transition-all hover:scale-105 shadow-lg"
            >
              Browse Products
            </Link>
            <Link
              href="/about"
              className="bg-transparent border-2 border-white text-white px-8 py-4 rounded-full font-semibold hover:bg-white hover:text-purple-600 transition-all hover:scale-105"
            >
              About Us
            </Link>
          </div>
