      ...
      <section className="py-20 bg-[#FFF8F0]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            {/* Review 1 */}
            <div className="bg-white rounded-xl shadow-lg p-6 border border-[#E07A2C]/10">
              <div className="flex items-center mb-4">
                {[...Array(5)].map((_, i) => (
                  <svg key={i} className="w-5 h-5 text-[#E07A2C] fill-current" viewBox="0 0 20 20">
              ...
              <div className="flex items-center space-x-3">
                <div className="w-10 h-10 bg-gradient-to-br from-[#E07A2C] to-[#8B5A2B] rounded-full flex items-center justify-center text-white font-bold">
                  JD
                </div>
                <div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 border border-[#E07A2C]/10">
              ...
              <div className="flex items-center space-x-3">
                <div className="w-10 h-10 bg-gradient-to-br from-[#8B5A2B] to-[#1a1a1a] rounded-full flex items-center justify-center text-white font-bold">
                  SM
                </div>
                <div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 border border-[#E07A2C]/10">
              ...
              <div className="flex items-center space-x-3">
                <div className="w-10 h-10 bg-gradient-to-br from-[#1a1a1a] to-[#E07A2C] rounded-full flex items-center justify-center text-white font-bold">
                  MK
                </div>
                <div>
