...
export default function AdminUsersPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#000000] via-[#2d1b4e] to-[#000000]">
      {/* Header */}
      <div className="bg-[#252525] border-b border-[#E8750A]/20 sticky top-0 z-40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex justify-between items-center">
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 bg-gradient-to-br from-[#E8750A] to-[#F59E0B] rounded-lg flex items-center justify-center">
            ...
            <Link
              href="/"
              className="flex items-center gap-2 px-4 py-2 text-gray-300 hover:text-[#E8750A] transition-colors"
            >
              <LogOut size={20} />
              Ana Sayfa
            </Link>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
          <div className="bg-[#252525] border border-[#E8750A]/20 rounded-lg p-6">
            <p className="text-gray-400 text-sm mb-2">Toplam Kullanıcı</p>
            <p className="text-3xl font-bold text-[#E8750A]">{users.length}</p>
          </div>
          <div className="bg-[#252525] border border-[#E8750A]/20 rounded-lg p-6">
        ...
        {loading ? (
          ...
          <div className="text-center py-12 bg-[#252525] rounded-lg border border-[#E8750A]/20">
          ...
          <div className="bg-[#252525] rounded-lg border border-[#E8750A]/20 overflow-hidden">
            <div className="overflow-x-auto">
              <table className="w-full">
                <thead className="bg-[#000000] border-b border-[#E8750A]/20">
                  <tr>
                ...
                <tbody className="divide-y divide-[#E8750A]/10">
                  {users.map((user) => (
                    <tr key={user.id} className="hover:bg-[#2d2d2d] transition-colors">
                      ...
                      <td className="px-6 py-4 text-sm">
                        <span className="px-3 py-1 bg-[#E8750A]/20 text-[#E8750A] rounded-full text-xs font-medium">
                          {user.platform}
                        </span>
                      </td>
