  ...
  return (
    <div className="min-h-screen bg-[#FAFAFA] flex flex-col items-center justify-center">
      ...
      <div className="relative flex items-center justify-center">
        ...
        {/* Core Loader */}
        <div className="w-16 h-16 bg-white rounded-2xl shadow-xl shadow-indigo-900/5 border border-slate-200 flex items-center justify-center relative z-10 animate-in zoom-in duration-300">
