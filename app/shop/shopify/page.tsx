...
export default function ShopifyShopPage() {
  return (
    <div className="min-h-screen bg-[#030712] text-white flex flex-col items-center justify-center relative overflow-hidden pt-20">
      <Particles className="absolute inset-0 z-0" quantity={150} color="#10b981" ease={40} />
      
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-emerald-600/10 rounded-full filter blur-[150px] animate-pulse-glow pointer-events-none" />
      ...
      >
        <BorderBeam size={400} duration={8} colorFrom="#10b981" colorTo="#34d399" />
        ...
        >
          <div className="relative">
            ...
            <Lock className="h-10 w-10 text-emerald-500 absolute -bottom-2 -right-2" />
          </div>
        </motion.div>
        ...
        >
          Shopify Module is <br/>
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 via-green-300 to-emerald-500 animate-text-shimmer">
            Under Construction
          </span>
        </motion.h1>

        <motion.p className="text-lg md:text-xl text-slate-400 mb-10 max-w-lg mx-auto leading-relaxed">
          Full backend integration for Shopify is in the works. Centralize your orders, sync products, and manage fulfillment directly from AllMySell.
        </motion.p>
