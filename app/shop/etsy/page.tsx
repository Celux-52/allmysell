...
export default function EtsyShopPage() {
  return (
    <div className="min-h-screen bg-[#030712] text-white flex flex-col items-center justify-center relative overflow-hidden pt-20">
      <Particles className="absolute inset-0 z-0" quantity={150} color="#f97316" ease={40} />
      ...
      >
        <BorderBeam size={400} duration={8} colorFrom="#f97316" colorTo="#ef4444" />
        ...
        >
          <div className="relative">
            ...
            <Lock className="h-10 w-10 text-orange-500 absolute -bottom-2 -right-2" />
          </div>
        </motion.div>
        ...
        >
          Etsy Module is <br/>
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 via-red-300 to-orange-500 animate-text-shimmer">
            Under Construction
          </span>
        </motion.h1>

        <motion.p className="text-lg md:text-xl text-slate-400 mb-10 max-w-lg mx-auto leading-relaxed">
          The ultimate Etsy SEO & Listing automation engine is being wired. Tag generation, title optimization, and print-on-demand sync are coming soon.
        </motion.p>
