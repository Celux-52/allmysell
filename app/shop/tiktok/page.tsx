...
export default function TikTokShopPage() {
  return (
    <div className="min-h-screen bg-[#030712] text-white flex flex-col items-center justify-center relative overflow-hidden pt-20">
      <Particles className="absolute inset-0 z-0" quantity={150} color="#ec4899" ease={40} />
      
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-pink-600/10 rounded-full filter blur-[150px] animate-pulse-glow pointer-events-none" />
      ...
      >
        <BorderBeam size={400} duration={8} colorFrom="#ec4899" colorTo="#d946ef" />
        ...
        >
          <div className="relative">
            ...
            <Lock className="h-10 w-10 text-pink-500 absolute -bottom-2 -right-2" />
          </div>
        </motion.div>
        ...
        >
          TikTok Shop Module is <br/>
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-400 via-fuchsia-300 to-pink-500 animate-text-shimmer">
            Under Construction
          </span>
        </motion.h1>

        <motion.p className="text-lg md:text-xl text-slate-400 mb-10 max-w-lg mx-auto leading-relaxed">
          The fastest growing marketplace integration is almost here. Automated video scraping, affiliate tracking, and seamless product sync are coming soon.
        </motion.p>
