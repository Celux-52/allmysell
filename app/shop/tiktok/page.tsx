...
export const metadata: Metadata = {
  title: 'TikTok Shop Store - AllMySell | Under Construction',
  description: 'AllMySell TikTok Shop store is currently under construction. Stay tuned for updates!',
};
...
export default function TikTokShopPage() {
  return (
    <div className="bg-[#1A1A1A] min-h-screen">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-pink-500 to-purple-700 text-cornsilk py-32">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl md:text-2xl text-pink-100 max-w-3xl mx-auto">
            Our TikTok Shop store is currently being built. We are working hard to bring you
      ...
      {/* CTA Section */}
      <section className="bg-gradient-to-r from-pink-500 to-purple-700 text-cornsilk py-16">
