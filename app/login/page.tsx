...
function LoginForm() {
  ...
  return (
    <div className="min-h-screen bg-[#030712] relative flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 overflow-hidden">
      {/* Dynamic Background Effects */}
      <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] rounded-full bg-orange-500/[0.07] blur-[120px] animate-pulse"></div>
      <div className="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] rounded-full bg-amber-500/[0.05] blur-[120px] animate-pulse" style={{ animationDelay: '2s' }}></div>

      <div className="max-w-md w-full space-y-8 relative z-10">
        {/* Header */}
        <div className="text-center">
          <div className="mx-auto h-20 w-20 bg-gradient-to-tr from-orange-500 to-amber-500 rounded-2xl flex items-center justify-center shadow-2xl shadow-orange-500/20 mb-6 transform hover:scale-105 transition-transform duration-300">
        ...
        {/* Form Container */}
        <div className="mt-8 glass-card py-10 px-8 shadow-2xl rounded-3xl">
          {error && (
          ...
          <div className="space-y-3 mb-6">
            <button
              ...
              className="w-full flex items-center justify-center gap-3 py-3.5 px-4 border border-white/10 rounded-xl bg-white/5 text-slate-300 hover:bg-white/10 hover:border-orange-500/30 transition-all duration-200 font-medium disabled:opacity-50 disabled:cursor-not-allowed"
            >
            ...
            <div>
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className="block w-full pl-12 pr-4 py-3.5 glass-input rounded-xl text-white sm:text-sm"
          ...
          <div className="mt-8 text-center">
            <p className="text-sm text-stone-500">
              ...
              <Link href="/register" className="font-semibold text-orange-400 hover:text-orange-300 transition-colors border-b border-orange-400/0 hover:border-orange-400/50 pb-0.5">
                Sign Up Now
              </Link>
            </p>
          </div>
