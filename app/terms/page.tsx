  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-olive via-peru to-indigo-50 py-12 px-4">
      <div className="max-w-4xl mx-auto bg-cornsilk rounded-2xl shadow-xl p-8 md:p-12">
        <h1 className="text-4xl font-bold mb-6 bg-stone-100 bg-clip-text text-transparent">
          Terms of Service
        </h1>
        <p className="text-stone-500 mb-8">Last updated: January 18, 2026</p>
        ...
        <div className="prose max-w-none">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-stone-900 mb-4">2. Multi-Platform E-Commerce</h2>
            <p className="text-stone-600 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-stone-900 mb-4">3. Product Information</h2>
            <p className="text-stone-600 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-stone-900 mb-4">4. Pricing and Payment</h2>
            <p className="text-stone-600 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-stone-900 mb-4">5. Shipping and Delivery</h2>
            <p className="text-stone-600 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-stone-900 mb-4">6. Returns and Refunds</h2>
            <p className="text-stone-600 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-stone-900 mb-4">7. Warranties</h2>
            <p className="text-stone-600 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-stone-900 mb-4">8. Intellectual Property</h2>
            <p className="text-stone-600 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-stone-900 mb-4">9. Prohibited Activities</h2>
            <p className="text-stone-600 leading-relaxed mb-4">
              You agree not to:
            </p>
            <ul className="list-disc list-inside text-stone-600 space-y-2 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-stone-900 mb-4">12. Changes to Terms</h2>
            <p className="text-stone-600 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-stone-900 mb-4">14. Contact Information</h2>
            <p className="text-stone-600 leading-relaxed mb-4">
            ...
            <ul className="list-none text-stone-600 space-y-2 mb-4">
              ...
              <li>🌐 Website: <a href="https://allmysell.com/contact" className="text-stone-800 hover:underline">allmysell.com/contact</a></li>
            </ul>
          </section>
