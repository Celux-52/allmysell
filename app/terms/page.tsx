      ...
      <div className="max-w-4xl mx-auto bg-cornsilk rounded-2xl shadow-xl p-8 md:p-12">
        ...
        <div className="prose max-w-none">
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-cornsilk mb-4">1. Agreement to Terms</h2>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-cornsilk mb-4">2. Multi-Platform E-Commerce</h2>
            <p className="text-gray-300 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-cornsilk mb-4">3. Product Information</h2>
            <p className="text-gray-300 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-cornsilk mb-4">4. Pricing and Payment</h2>
            <p className="text-gray-300 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-cornsilk mb-4">5. Shipping and Delivery</h2>
            <p className="text-gray-300 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-cornsilk mb-4">6. Returns and Refunds</h2>
            <p className="text-gray-300 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-cornsilk mb-4">7. Warranties</h2>
            <p className="text-gray-300 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-cornsilk mb-4">8. Intellectual Property</h2>
            <p className="text-gray-300 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-cornsilk mb-4">9. Prohibited Activities</h2>
            <p className="text-gray-300 leading-relaxed mb-4">
              You agree not to:
            </p>
            <ul className="list-disc list-inside text-gray-300 space-y-2 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-cornsilk mb-4">10. Limitation of Liability</h2>
            <p className="text-gray-300 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-cornsilk mb-4">11. Indemnification</h2>
            <p className="text-gray-300 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-cornsilk mb-4">12. Changes to Terms</h2>
            <p className="text-gray-300 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-cornsilk mb-4">13. Governing Law</h2>
            <p className="text-gray-300 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-cornsilk mb-4">14. Contact Information</h2>
            <p className="text-gray-300 leading-relaxed mb-4">
              If you have any questions about these Terms of Service, please contact us:
            </p>
            <ul className="list-none text-gray-300 space-y-2 mb-4">
