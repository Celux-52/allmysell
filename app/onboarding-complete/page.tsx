  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#000033] via-[#330066] to-[#8F00FF] flex items-center justify-center py-12 px-4">
      <div className="w-full max-w-2xl">
        <div className="bg-white rounded-2xl shadow-2xl p-8 md:p-12 animate-scaleIn text-center">
          {/* Success Icon */}
          ...
          {/* Heading */}
          <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-3 animate-slideInUp">
          ...
          {/* Profile Summary */}
          {userInfo && (
            <div className="bg-gradient-to-br from-purple-50 to-blue-50 p-6 rounded-xl mb-8 animate-slideInUp" style={{ animationDelay: '0.2s' }}>
              <div className="grid md:grid-cols-3 gap-4 text-center">
                ...
                <div>
                  ...
                  <p className="text-gray-900 font-semibold">{platformNames[userInfo.platform] || userInfo.platform}</p>
                </div>
                <div>
                  <p className="text-gray-600 text-sm mb-1">Aylık Hacim</p>
                  <p className="text-gray-900 font-semibold">{orderLabels[userInfo.monthlyOrders] || userInfo.monthlyOrders}</p>
                </div>
              </div>
            </div>
          )}
          ...
          {/* Next Steps */}
          <div className="bg-blue-50 border-2 border-blue-200 p-6 rounded-xl mb-8 animate-slideInUp" style={{ animationDelay: '0.3s' }}>
            <h3 className="text-lg font-bold text-gray-900 mb-4 flex items-center justify-center gap-2">
              <Gift size={24} className="text-[#8F00FF]" />
              Sana Hazır İçerik
            </h3>
            <ul className="space-y-2 text-left">
              <li className="flex items-start gap-3">
                <span className="text-[#8F00FF] font-bold">✓</span>
          ...
          <div className="flex flex-col sm:flex-row gap-4 animate-slideInUp" style={{ animationDelay: '0.4s' }}>
            <Link
              href="/"
              className="flex-1 bg-gradient-to-r from-[#8F00FF] to-[#0000FF] text-white py-3 px-6 rounded-lg font-semibold hover:shadow-lg transition-all flex items-center justify-center gap-2"
            >
              Anasayfaya Dön <ArrowRight size={20} />
            </Link>
            <Link
              href="/shop/ebay"
              className="flex-1 border-2 border-[#8F00FF] text-[#8F00FF] py-3 px-6 rounded-lg font-semibold hover:bg-purple-50 transition-all"
            >
              Ürünleri Gez
            </Link>
          </div>
          ...
          <p className="text-gray-500 text-sm mt-8">
            ...
            <Link href="/contact" className="text-[#8F00FF] hover:underline">
              iletişim
            </Link>
